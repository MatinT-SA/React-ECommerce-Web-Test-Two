...
const AddressForm = ({ checkoutToken, next }) => {
    ...
    const fetchShippingCountries = async (checkoutTokenId) => {
        ...
        //the line below will return an array for us containing the keys of each country like BR, CA, DE and etc... and we are only gonna select the first country selected in this array.
    ...
    useEffect(() => {
        //the if statement is because sometimes this is going to be empty.
